 ...
 * Generated at: 2024-01-08 05:04:46 UTC
...
public final class uploadJquery_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		\r\n");
      out.write("// 		<span>x 눌렀을 경우 삭제하는 메소드 생성\r\n");
      out.write("		$(\".uploadResult\").on(\"click\",\"span\",function(){\r\n");
      out.write("			\r\n");
      out.write("			var targetFile = $(this).data(\"file\"); //<span data-file>값\r\n");
      out.write("			var type = $(this).data(\"type\");\r\n");
      out.write("			var uploadResultItem = $(this).closest(\"li\"); // 해당 span태그의 가장 가까운 <li>태그\r\n");
      out.write("			\r\n");
      ...
      out.write("				,type:\"post\"\r\n");
      out.write("				,sucess: function(result){\r\n");
      out.write("					uploadResultItem.remove();\r\n");
      out.write("					alert(result);\r\n");
      out.write("					// 브라우저에서 해당 썸네일이나 첨부파일 이미지 제거\r\n");
      out.write("				}\r\n");
      out.write("			});\r\n");
      ...
      out.write("// 				\r\n");
      out.write("			\r\n");
      out.write("				if(!obj.image){ // 이미지 파일이 아닌경우 파일모양의 이미지 출력\r\n");
      out.write("// 					\r\n");
      out.write("					var fileCallPath=encodeURIComponent(obj.uploadPath+\"/\"+obj.uuid+\"_\"+obj.fileName);\r\n");
      out.write("// 					파일 다운로드하기위해 <a>태그에 컨트롤러 /download 메소드에 fileCallpath 넣어 호출\r\n");
      out.write("// 					str += \"<li><div><a href='./download?filename=\"+fileCallPath+\"'>\"\r\n");
      out.write("// 							+\"<img src='./resources/image/attach.png'>\"+obj.fileName+\"</a>\"\r\n");
      ...
      out.write("							\r\n");
      out.write("							\r\n");
      out.write("				}else {	// 이미지 파일인 경우 썸네일 출력	\r\n");
      out.write("// 					썸네일 파일 경로 + 이름\r\n");
      ...
      out.write("// 					정규식 : 백슬래시(\\)를 모두 슬래시(/)로 변경 \r\n");
      ...
      out.write("//				<img>태그의 src에 컨트롤러의 /display경로의 getFile()메소드 호출 \r\n");
      ...
      out.write("					+fileCallPath+\"'></a><span data-file=\\'\"+fileCallPath+\"\\' data-type='image'>x</span></li>\";\r\n");
      out.write("				\r\n");
      out.write("				\r\n");
      out.write("				}\r\n");
      out.write("\r\n");
      ...
      out.write("			setTimeout(function(){ // 원본 이미지 클릭시 hide(1초)로 사라짐.\r\n");
      out.write("				$(\".bigPictureWrapper\").hide();\r\n");
      out.write("			},1000); // end of setTimeout\r\n");
      out.write("			}); //end of .bigPictureWrapper Click\r\n");
      out.write("		\r\n");
      out.write("	}); // end of ready function\r\n");
      out.write("		\r\n");
      out.write("// 	이미지를 보여주는 함수\r\n");
      ...
      out.write("// 		bigPicture클래스의 div의 html요소에 컨트롤러 메소드 호출하여 원본 이미지 파일을 출력하는 img태그를 삽입한다. \r\n");
